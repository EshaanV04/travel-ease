...
public class ExploreHotels extends JFrame implements Runnable {
    ...
    public void run(){
        String[] text = new String[]{ "JW Marriot Hotel", "Madarin Oriental Hotel", "Four Seasons Hotel", "Raddinson Blue Hotel", "Classio Hotel", "The Bay Club Hotel", "Breeze Blow Hotel", "The Taj Hotel", "Sahara Star Hotel", "River View Hotel" };
